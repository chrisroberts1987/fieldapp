...
import { HamburgerIcon, CloseIcon } from '../components/NavIcons';
...
function Nav({ router }) {
  ...
  return (
    <>
      ...
      <MobileNavPanel open={open} close={close} router={router} variant="home"/>
    </>
  );
}

function MobileNavPanel({ open, close, router, variant }) {
  if (!open) return null;
  ...
  return (
    <div style={{
      ...
      <div style={{
        height:1, background:C.border, margin:'10px 0',
      }}/>
