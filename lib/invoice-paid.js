...
export async function markInvoicePaidWithCascade({
  ...
  await cascade({ invoiceId, orgId, userId, customerId, amount }).catch((e) => {
...
async function cascade({ invoiceId, orgId, userId, customerId, amount }) {
