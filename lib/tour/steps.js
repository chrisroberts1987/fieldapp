...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: "Approved quotes drop in here automatically. Tap + NEW to add a job manually. Inside each job you can assign a crew member, schedule a date, and log hours and expenses.",
    primary: 'Next',
  },
  {
    id: 'invoices',
