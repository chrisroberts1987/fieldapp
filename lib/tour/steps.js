...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: "AI features are included in your plan. Fair usage guidelines apply to keep the platform sustainable for everyone. Cached responses are always free and never count toward your totals. View your AI usage anytime in the Insights tab.",
    primary: 'Got it',
  },
  {
    id: 'setup',
