...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: "Build a quote with line items in 60 seconds. The customer approves it from their phone — no email tag. The moment they approve, MyForeman creates the job for you.",
    primary: 'Next',
  },
  {
    id: 'jobs',
