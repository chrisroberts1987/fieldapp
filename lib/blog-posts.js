...
export const BLOG_POSTS = [
  ...
  {
    slug: 'how-to-start-a-trade-or-service-business',
    category: 'growth',
    title: 'How to Start a Trade or Service Business',
    description: 'The essentials for the first year of a new trade or service business. Getting legal, pricing your first jobs, finding your first customers, sizing up the competition, and what to skip.',
    metaTitle: 'How to Start a Trade or Service Business (2026 Guide)',
    metaDescription: 'A no-fluff guide for new trade and service business owners. Licenses, pricing, customer acquisition, competition, and the cash flow mistakes that kill new shops.',
    publishedAt: '2026-06-20',
    readingTime: '8 min read',
    intro: 'Most people who start a trade or service business already know how to do the work. The hard part is everything around the work. Getting paid, finding customers, knowing what to charge, deciding what to ignore. Here is what actually matters in the first year.',
    blocks: [
      { type: 'h2', text: 'The honest starting point' },
      { type: 'p', text: 'You do not need a perfect logo, a slick website, or a thousand dollar business card to start. You need a license, basic insurance, a way to take payment, and a phone customers will answer. Everything else can wait.' },
      { type: 'p', text: 'The owners who succeed in year one focus on two things. Doing good work, and getting in front of people who need it. Every section of this guide ladders up to one of those two.' },

      { type: 'h2', text: 'Get the legal stuff out of the way fast' },
      { type: 'p', text: 'Set up an LLC. It takes an afternoon and costs $50 to $300 depending on your state. It separates your business from your personal finances and gives you basic legal protection if something on a job site goes wrong.' },
      { type: 'p', text: 'Get an EIN from the IRS for free. Open a business checking account. Run every dollar of business income and expense through it. Never mix personal and business spending. Future you will thank present you when tax season rolls around.' },
      { type: 'p', text: 'Pull whatever license your state or city requires for your trade. Some states are strict, others barely care. Look it up before you take the first paying job. Working unlicensed is the kind of mistake that ends a business before it starts.' },
      { type: 'p', text: 'Carry general liability insurance. A million dollar policy runs $40 to $80 a month for most solo trades and is the difference between a bad day on a job and losing your house. Add commercial auto if you drive a work truck. Add workers comp the day you hire your first employee.' },

      { type: 'h2', text: 'Pricing when nobody knows you yet' },
      { type: 'p', text: 'The temptation when you are starting out is to be cheap. Cheaper than the competition, cheaper than the going rate, cheap enough that nobody can say no. This is the fastest way to ruin a new business.' },
      { type: 'p', text: 'Cheap customers are the worst customers. They argue about every line item. They expect more than they paid for. They take three months to pay a five hundred dollar invoice. They write the angriest reviews.' },
      { type: 'p', text: 'Charge in the middle of the market. Call five other shops in your area and ask for a quote on a sample job. Average them. Charge that. You are not the cheapest and you are not the most expensive. You are normal, and normal is where most of the business is.' },
      { type: 'p', text: 'Quote in person whenever possible. Most jobs are not what they sound like over the phone. The closet you thought was simple has a fuse box behind drywall. Quote on site, in writing, with a real number. Phone quotes get blown up and the customer ends up disappointed.' },

      { type: 'h3', text: 'A simple pricing framework' },
      { type: 'p', text: 'For most trades, your number breaks down like this. Materials at cost plus 20 to 50 percent markup. Labor at your hourly target rate times the realistic hours. Then 10 to 20 percent overhead. Then 10 to 20 percent profit on top of that.' },
      { type: 'p', text: 'Do the math on a calculator, write down the bottom number, and quote that. Do not negotiate against yourself. If a customer pushes back, take work out of the scope. Never lower the rate. The minute you discount your work, you teach the next customer to expect a discount too.' },

      { type: 'h2', text: 'Where your first customers actually come from' },
      { type: 'p', text: 'Your first ten customers are not coming from Google Ads. They are coming from people who already trust you, and from people who live within five miles of your house. Spend zero dollars on ads in month one. Spend the time on the four things below instead.' },
      { type: 'ul', items: [
      ...
      { type: 'h2', text: 'Sizing up the competition without obsessing' },
      { type: 'p', text: 'Look at your competition once, take notes, then mostly ignore them. Spend an hour on Google Maps in your area searching for your trade. Look at the top five listings. Read their reviews. That is the whole exercise.' },
      { type: 'ul', items: [
      ...
      { type: 'p', text: 'Do not waste a month building a competitive analysis spreadsheet. Most local trade competition wins or loses on three things. Response time, professionalism, and reviews. Beat them on those three and you will steal business from contractors who have been around for ten years.' },
      { type: 'p', text: 'The contractor who returns the call in fifteen minutes beats the one who calls back the next day. Almost every time.' },

      { type: 'h2', text: 'The Google review flywheel' },
      { type: 'p', text: 'Reviews are the single most valuable asset a new service business can build. They cost nothing to acquire and they pay forever. A business with twenty five star reviews on Google looks like a real business. One with three reviews looks like a hobby.' },
      { type: 'p', text: 'After every completed job, send a short text. Something like, "Hey, thanks for the work today. Reviews really help small businesses like ours. Mind leaving us one on Google?" Include a direct link to your Google review page. Make it one tap.' },
      { type: 'p', text: 'Ask every single time. Half of customers will ignore the message. The other half will respond, and the ones who do will write something honest. Five reviews in month one, ten by month three, fifty by year one. That is how the flywheel starts.' },

      { type: 'h2', text: 'What to skip in year one' },
      { type: 'ul', items: [
      ...
      { type: 'h2', text: 'The first cash flow trap' },
      { type: 'p', text: 'The first year is not about how much you make. It is about how much you keep. Most new contractors run out of money even when work is steady, because they did not separate money in from money out.' },
      { type: 'p', text: 'Take 30 percent of every payment that hits your business account and move it to a savings account. That is your tax money and your slow month money. Touch it for nothing else. The IRS does not accept "I forgot" as a valid excuse.' },
      { type: 'p', text: 'Pay yourself a set weekly amount that you can live on, even when a big check just hit. The temptation to spend a flush week on a new tool or a truck upgrade is the trap that kills new businesses. Treat extra cash like it is not there. Let the account build up for two or three months before you make any big purchase.' },

      { type: 'h2', text: 'The thing nobody tells you' },
      { type: 'p', text: 'The first six months of a service business are usually quiet. You will second guess the whole thing. You will wonder if the steady paycheck you walked away from was the smarter call. That is normal.' },
      { type: 'p', text: 'The owners who make it are the ones who keep showing up, keep doing good work for the customers they have, and keep asking for the next job. Most service businesses die in month three from boredom and doubt, not from lack of work. Push through. Year two is where the compounding starts. By year three, the phone rings without you working at it.' },

      { type: 'h2', text: 'Closing thought' },
      { type: 'p', text: 'Starting a trade or service business does not require talent, luck, or a perfect plan. It requires showing up, charging fairly, asking for reviews, and not running out of cash in the first year. Most owners who do those four things get there. The hard part is being patient enough to let the work compound.' },
    ],
  },
];
